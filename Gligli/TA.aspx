<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TA.aspx.cs" Inherits="Gligli.TA" %>
...
<body>
    ...
    <div id="box2">
        ...
        <div class="box2-1 grid">
            <ul class="box2-1 grid-cell-4">
                ...
                <li><input type="text" style="width:100px;height: 25px;" placeholder="搜索" class="space_input"></li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-2">
        ...
        <h3 class="section-title">
            <a href="My video.aspx" class="t">TA的视频</a>
    ...
    <div class="col-4">
        <div class="col-4-a">
            <a href="Collection.aspx" class="">TA的收藏夹</a>
    ...
    <div class="col-3">
        <div class="col-3-a">
            <a href="special_column.aspx" class="">TA的专栏</a>
        </div>
