<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyVideo.aspx.cs" Inherits="Gligli.MyVideo" %>
            ...
            <ItemTemplate>
                 <div class="col-2-img1">
                     <a href="#">
                        ...
                        <span style="font-size: 8px;" class="col-2-span">收藏于：<span><%# Eval("uptime") %></span></span>
                     </a>
                 </div>
            </ItemTemplate>
        </asp:Repeater>
