...
<body>
        ...
        <div class="grid">
            ...
            <div class="header-right grid grid-cell-1">
                ...
                <div class="right-login">
                    <a href="#" class="login-img"><img src="./img/akari.jpg" alt=""/></a>
                    <a href="#">登录</a>
                    <a href="#">注册</a>
                </div>
                <!-- 登录状态 -->
                <div class="userlogin grid">
                    <div class="userimg">
                        <a href="#"><img src="./img/akari.jpg" alt=""/></a>
                        <div class="user-item">
                ...
                <div class="right-up">
                    ...
                    <div class="up-box">
                        <ul>
                            <li><a href="#"><img src="./img/tg1.png" alt=""/>专栏投稿</a></li>
                            <li><a href="#"><img src="./img/tg2.png" alt=""/>音频投稿</a></li>
                            <li><a href="#"><img src="./img/tg3.png" alt=""/>视频投稿</a></li>
                            <li><a href="#"><img src="./img/tg4.png" alt=""/>稿件管理</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="content-box grid">
            <div class="content-left">
                    <div class="video-title"><span></span><h3><%=Session["title"] %></h3></div>
                    ...
                    <div class="video-buttom grid"><div class="grid-cell-2">&nbsp;&nbsp;&nbsp;<span class="man-num"><%=Application["count"] %></span>&nbsp;人正在观看&nbsp;,&nbsp;<span class="bullet_num">3000</span>&nbsp;条弹幕</div>
                    <div class="grid-cell-2"><div id="bullet_switch"><div id="bullet_switch--btn"></div></div></div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                              ...
                                              <%foreach (var item in list){%>
                                                    <div class='commentbox-listitem' data-id="<%=item.userID %>">
                                                        ...
                                                        <div class='commentbox-con'>
                                                            ...
                                                            <span class='unlike'><i class='fa fa-thumbs-o-down' aria-hidden='true'></i></span>
                                                            ...
                                                            <div class='reply-box'>
                                                                    <%foreach (var value in dic[item.comID]) {%>
                                                                         <div class='reply-item'>
                                                                               <a href='#' class='reply-head'><img src='<%=value.imageUrl%>' width='24' height='24'/></a>
                                                                               <div class='reply-item__user'>
                                                                                ...
                                                                                <div class='reply-item__info'>
                                                                                 <div class='info'>
                                                                                     <span class='reply-item__time'><%=value.comtime%></span>
                                ...
                                <div id="commentbox-bottom">
                                        <div class="commentbox-bottom">
                                            ...
                                            <div class="jump">共<label class="bottom-num"><%=Session["Count"]%></label>页,跳至<asp:TextBox ID="TextBox3" runat="server" OnTextChanged="num_TextChanged"></asp:TextBox>页</div>
                                        </div>
                                        <div class="commentbox-send">
                                            <div class="user-head">
                                                <img src="./img/akari.jpg" width="48" height="48" alt=""/>
