<%@ Page Title="" Language="C#" MasterPageFile="~/GliMS.Master" AutoEventWireup="true" CodeBehind="TA video.aspx.cs" Inherits="Gligli.TA_video" %>
    ...
    <div id="box2">
        ...
        <div class="col-1">
            ...
            <div class="col-1-img" style="overflow: auto;">
                ...
                <h2><font face="微软雅黑" size="5px" style="margin-left: 20px;" color="#3333FF">TA的视频！</font></h2>
