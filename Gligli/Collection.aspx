<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Collection.aspx.cs" Inherits="Gligli.Collection" %>
...
<head>
    ...
    <link rel="stylesheet" href="./Content/css/Collection.css">
...
<body>
    ...
    <div class="col-1">
        ...
        <div class="col-1-img" style="overflow: auto;">
            ...
            <h2><font face="微软雅黑" size="5px" style="margin-left: 20px;" color="#3333FF">默认收藏夹！</font></h2>
            <p><font size="2" style="margin-left: 20px;" style="margin-top: 5px;" color="#FF00CC"><a href="Collection column.aspx" style="color:#00a1d6">收藏的专栏</a></font></p>
            <asp:TextBox ID="TextBox1" CssClass="TextBox1" runat="server"></asp:TextBox>
            <p><font size="2" style="margin-left: 20px;" style="margin-top: 10px;" color="#FF00CC"><asp:Button ID="Button1" CssClass="col-1-button" runat="server" Text="点击搜索" OnClick="Button1_Click1"></asp:Button><%--<input type="button" class="col-1-button" value="播放全部视频">--%></font></p>
        </div>
            </form>
    </div>
