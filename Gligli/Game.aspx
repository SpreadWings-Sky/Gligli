<%@ Page Title="" Language="C#" MasterPageFile="~/GliMS.Master" AutoEventWireup="true" CodeBehind="Game.aspx.cs" Inherits="Gligli.Game" %>
    ...
    <section style="margin-top: 30px;">
        <div id="section" class="grid">
            <div class="section-nav">
                <div id="section-nav">
                    ...
                    <ul>
                        ...
                        <li><a href="Game.aspx" style="color: #00a1d6;">游戏</a></li>
            ...
            <div class="section-tu">
                ...
                <div class="news-item">
                    <h2 style="text-align:center">游戏文章</h2>
