<%@ Page Title="" Language="C#" MasterPageFile="~/GliMS.Master" AutoEventWireup="true" CodeBehind="TA special_column.aspx.cs" Inherits="Gligli.TA_special_column" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="box2-1 grid">
            <ul class="box2-1 grid-cell-4">
               <li><a href="" class="box2-1-a" id="con" onmouseover="overShow()" onmouseout="outHide()"><img src="./Content/img/m3.png" alt=""> 主页</a></li>
                <li><a href='TA video.aspx?UserID=<%=Request["UserID"] %>'><img src="./Content/img/m11.png" alt=""> 视频</a></li>
                <li><a href='TA special_column.aspx?UserID=<%=Request["UserID"] %>'><img src="./Content/img/m10.png" alt=""> 专栏</a></li>
            </ul>
        </div>
    </div> 
    ...
    <div class="col-1">
        <div class="col-1-img" style="overflow: auto;">
            <h2><font face="微软雅黑" size="5px" style="margin-left: 20px;" color="#3333FF">TA的专栏</font></h2>
        </div>
    </div>
