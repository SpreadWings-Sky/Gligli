<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="special_column.aspx.cs" Inherits="Gligli.special_column" %>
...
<body>
    ...
    <div class="col-1">
        <div class="col-1-img" style="overflow: auto;">
            <h2><font face="微软雅黑" size="5px" style="margin-left: 20px;" color="#3333FF">我的专栏</font></h2>
        </div>
    </div>
