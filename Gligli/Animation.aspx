<%@ Page Title="" Language="C#" MasterPageFile="~/GliMS.Master" AutoEventWireup="true" CodeBehind="Animation.aspx.cs" Inherits="Gligli.Animation" %>
    ...
    <section style="margin-top: 30px;">
        <div id="section" class="grid">
            <div class="section-nav">
                <div id="section-nav">
                    ...
                    <ul>
                        ...
                        <li><a href="Animation.aspx" style="color: #00a1d6;">动画</a></li>
            ...
            <div class="section-tu">
                ...
                <div class="news-item">
                    <h2 style="text-align:center">动漫文章</h2>
