<%@ Page Title="" Language="C#" MasterPageFile="~/GliMS.Master" AutoEventWireup="true" CodeBehind="Music.aspx.cs" Inherits="Gligli.Music" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<link rel="stylesheet" href="./css/section.css"/>
    <script src="js/jquery-3.3.1.min.js"></script>s
</asp:Content>
            ...
            <div class="section-nav">
                ...
                <span>GliGli专栏</span>
                    <ul>
                        ...
                        <li><a href="Music.aspx"  style="color: #00a1d6;">音乐</a></li>
